package com.example.quickdevelop.utils.permission;
...
/**
 * @Description: 对EasyPermision 的二次封装,使用EasyPermision进行权限的申请处理 里面, 使用PermissionsManager 申请管理权限
 */
public class PermissionsUtils {
    ...
    public static void requestPerssions(Activity activity, String rationale, String... permissions) {
        requestPerssions(activity, rationale, AFTERCODE, permissions);
    }
    ...
    private static void startEasyPermission(@NonNull Activity activity, String rationale, int requestCode, String... permissions) {
...
//        }
    ...
    private static void startEasyPermission(@NonNull Fragment fragment, String rationale, int requestCode, String... permissions) {
...
//        }
    ...
    @SuppressLint("NewApi")
    private static void startEasyPermission(@NonNull android.app.Fragment fragment, String rationale, int requestCode, String... permissions) {
